...
void Enemy_Infary::UpdateState()
{
	Game_MovableEnemy::UpdateState();
}

void Enemy_Infary::Update(DWORD dt, vector<PGAMEOBJECT>* coObjects)
{
	Game_MovableEnemy::Update(dt, coObjects);
}

void Enemy_Infary::OnCollisionWith(PCOLLISIONEVENT e)
{
...
void Enemy_Infary::Execute_DieAction()
{
